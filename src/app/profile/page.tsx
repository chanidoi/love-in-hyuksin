    ...
    <div className="min-h-screen bg-[#FDF2F4] pb-24">
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-8">
        ...
        <div 
          ...
          className="bg-white rounded-2xl p-4 shadow-sm flex items-center justify-between cursor-pointer hover:bg-gray-50 transition-colors mb-4"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-yellow-50 rounded-full flex items-center justify-center">
              <span className="text-yellow-500 text-xl">⭐</span>
            </div>
            <span className="font-medium text-gray-800">찜한 프로필 보기</span>
          </div>
